...
--
-- Host: localhost
-- Generation Time: May 10, 2018 at 10:44 AM
...
(41, 12, 'What is HTML', 'HTML', '5', 'hg', 'uyg', 1),
(42, 12, 'How to save HTML file ?', '.txt', '.java', '.html', '.css', 3),
(43, 13, 'what is ?', 'a', 'b', 'c', 'd', 3),
(44, 14, 'vsvdsvdhv ?', 'a', 'd', 'c', 'g', 2),
(45, 14, 'udhsjdhsgdjgsd?', '4', 'w', '7', '5', 2),
(46, 15, 'rthyjghkl', 'q', 'd', 'c', 'b', 2),
(47, 15, 'hfgjhbfjhsbf?', 't ', 'f', 'k', '8', 1);
...
('dhairya', 12, '0000-00-00', 2),
('test', 12, '0000-00-00', 1),
('test', 13, '0000-00-00', 0),
('dhairya', 14, '0000-00-00', 2),
('dhairya', 12, '0000-00-00', 1),
('dhairya', 12, '0000-00-00', 1),
('dhairya', 15, '0000-00-00', 1);
...
(1000, 'dhairya', 'dhairya', 'dhairya', '123', 'chd', 989898989, 'hg@jh.dd'),
(1001, 'test', '123', 'tester', '', '', 0, '');
...
--
ALTER TABLE `mst_user`
  MODIFY `user_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1002;
COMMIT;
